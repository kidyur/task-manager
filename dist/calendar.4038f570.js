...
class Day {
    ...
    constructor(day, borderFlag, iconURL){
        ...
        if (day == datePicker.day) this.select();
    }
    #createIcon() {
    ...
    select() {
        datePicker.day = this.#element.textContent;
        offLastWeek();
...
class Calendar {
    ...
    update() {
        ...
        const monthBeginning = new Date(`${year1}-${month1}-1`);
    ...
    #createEmptyDays() {
        const monthBeginning = new Date(`${datePicker.year}-${datePicker.month}-1`);
...
class DatePicker {
    ...
    #setupButton() {
        ...
        monthPickerBtn.addEventListener('click', ()=>{
            const picker1 = document.getElementById('month-picker');
    ...
    #createSeparator() {
        ...
        const yearEl1 = document.createElement('div');
...
class Month {
    ...
    constructor(){
        ...
        el.textContent = name;
        if (year == this.year) monthEl.classList.add('month-picker__month_current');
        if (month == this.month && year == this.year) monthEl.classList.add('month-picker__month--active');
    }
    select() {
        monthEl.classList.add('month-picker__month--active');
        datePicker.offLastYear();
        datePicker.onYear(year);
        monthTitleEl.textContent = months[month - 1];
...
},{"./app":"5Gnd7","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
},{}]},["3X5ox","9XFF7"], "9XFF7", "parcelRequire0af5", {})
