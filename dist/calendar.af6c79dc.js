...
})({"7ky0e":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b8039335af6c79dc";
"use strict";
...
},{}],"jRUWL":[function(require,module,exports,__globalThis) {
...
class Schedule {
    ...
    constructor(empty_flag = false){
        if (!empty_flag) {
            ...
            group.addEventListener('click', ()=>{
                this.select();
                (0, _schedulesDataMjsDefault.default).currentSchedule = this;
            });
    ...
    createDeleteBtn() {
        ...
        deleteBtn.addEventListener('click', ()=>{
            (0, _schedulesDataMjsDefault.default).removeSchedule(this);
            (0, _schedulesDataMjsDefault.default).currentSchedule = new Schedule();
...
function updateCreateScheduleBtn() {
    ...
    if ((0, _schedulesDataMjsDefault.default).getSchedulesLength() >= 3) btn.classList.add('schedule-page__add-schedule-btn--passive');
